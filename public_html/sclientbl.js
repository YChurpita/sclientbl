   ...
   var slTitle =["Материалы клиентам компании","Materials Company customers","Materials Company Kunden"],
       ...
       slNewsRu=["Объем газа в ПГХ Украины на 23 мая составляет 9 миллиардов кубометров",
        ...
        hrefMat=[[
               ...
               ["index.php?option=com_content&view=article&id=195:litsenziya-na-pererabotku-ru&catid=11:toplivo-i-energetika-ru",
                "index.php?option=com_content&view=article&id=195:litsenziya-na-pererabotku-ru&catid=11:toplivo-i-energetika-ru",
                "index.php?option=com_content&view=article&id=195:litsenziya-na-pererabotku-ru&catid=11:toplivo-i-energetika-ru"], 
               [
 ...
 /*----------------------------------------------------------------------------*/                    
        this.Init= function(aLang){
             ...
             if (aLang==="ru"){
                ...
                hrefMatBuf =hrefMat[[0],[0],[0],[0],[0],[0],[0],[0],[0]];
             ...
             if (aLang==="en"){
                ...
                hrefMatBuf =hrefMat[[1],[1],[1],[1],[1],[1],[1],[1],[1]];
             };
             ...
             if (aLang==="de"){
                ...
                hrefMatBuf =hrefMat[[2],[2],[2],[2],[2],[2],[2],[2],[2]];
             };
